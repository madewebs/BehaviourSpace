...
export default function About() {
  return (
    <div className='bg-[#fefefe] text-[#00494b] w-full py-10 md:py-14 px-4 md:px-6'>
      ...
      <div className='max-w-full mx-auto md:max-w-7xl flex flex-col lg:flex-row gap-4 items-stretch md:items-center'>
        ...
        <div className='flex-1 inter text-[#00412b]'>
          ...
          <p className='mt-2 md:mt-3 font-normal italic text-2xl md:text-3xl'>
            Reset Anxiety. Rebuild Balance. Reclaim You.
          </p>

          <p className='mt-4 md:mt-5 text-lg md:text-xl leading-relaxed'>
